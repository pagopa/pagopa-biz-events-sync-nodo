...
public interface BizEventsSyncNodoService {
  ...
  long checkBizEventsDiffAtDate(
      String bizEventMinDate,
      String bizEventMaxDate,
      String nodoMinDate,
      String nodoMaxDateReceipt);

  List<NodoReceiptInfo> retrieveNotElaboratedNodoReceipts(
      String bizEventMinDate,
      String bizEventMaxDate,
      String nodoMinDate,
      String nodoMaxDateReceipt);
